  ...
  return (
    <>
      ...
      <Tabs p="20px" variant="enclosed" colorScheme="purple" minH="70vh">
        <TabList>
          <Tab fontWeight="500" fontSize="20px" _selected={{ bg: "gray.100" }}>
            Đơn đặt bàn
          </Tab>
          <Tab fontWeight="500" fontSize="20px" _selected={{ bg: "gray.100" }}>
            Xem lịch của bàn
        ...
        <TabPanels py="10px">
          <TabPanel>
            <SearchFilter
              searchPlaceholder={
                "Tìm kiếm theo số điện thoại, ngày, giờ đặt, loại bàn, mã bàn, giá tiền"
              }
              data={bookings.filter((book) => book.firstSlotId)}
              methods={[
                              ...
                              <HStack spacing={5}>
                                <Text>
                                  {book.firstSlotId === book.lastSlotId
                                    ? slotMap[book.firstSlotId] +
                                      " - " +
                                      Number(
                                        Number(slotMap[book.firstSlotId]) + 1
                                      )
                                    : slotMap[book.firstSlotId] +
                                      " - " +
                                      Number(
                                        Number(slotMap[book.lastSlotId]) + 1
                                      )}
                                </Text>
                            ...
                            <Td>
                              <HStack spacing={5}>
                                {book.bookingStatusId === 1 ? (
                                  ...
                                  <Text color="gray.500">(Đã thanh toán)</Text>
                                )}
                              </HStack>
                            </Td>
                          </Tr>
