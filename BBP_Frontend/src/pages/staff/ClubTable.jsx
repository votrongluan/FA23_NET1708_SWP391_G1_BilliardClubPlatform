...
function ClubTable(props) {
  ...
  return (
    <CheckClubAuth>
      ...
      <HStack mt={5}>
        <Spacer />
        <Button leftIcon={<EditIcon />} colorScheme="telegram" onClick={onOpen}>
          Cập nhật
        </Button>
      </HStack>
      <SearchFilter
        searchPlaceholder="Tìm kiếm theo loại bàn, mã bàn"
        data={tables}
        methods={[
                              ...
                              try {
                                ...
                                if (res.data.status == "Ok") {
                                  ...
                                  toast({
                                    title: "Xóa thất bại",
                                    description:
                                      "Bàn không được xóa khỏi hệ thống",
                                    status: "error",
                                    duration: 700,
                                    position: "top-right",
                                  });
